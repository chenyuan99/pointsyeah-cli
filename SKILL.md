---
name: pointsyeah
description: Generate PointsYeah deep-link search URLs for award flights and hotel availability — no scraping, no API keys required.
version: 0.1.0
metadata:
  openclaw:
    emoji: "✈️"
    homepage: https://github.com/chenyuan99/pointsyeah-cli
    requires:
      bins:
        - pointsyeah
    install:
